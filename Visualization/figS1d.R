...
setwd('G:/AI_XuLab_Data/Radial-C/figureS1/FigS1/FigS1d/')

df <- read.table("score_20M_FigS1d.bed", header = T)
...
ggsave("G:/AI_XuLab_Data/Radial-C/figS1d.png", width = 3.8, height = 3.8, dpi = 600)