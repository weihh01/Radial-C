...
wilcox.test(enrichment_m[enrichment_m$type == "LaminAC_nona.bed", "sig"],
            enrichment_m[enrichment_m$type == "LaminB1_nona.bed", "sig"], 
            alternative = c("two.sided"), paired = TRUE)$p.value
