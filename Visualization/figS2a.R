...
setwd("G:/AI_XuLab_Data/Radial-C/figureS2/FigS2a/")
score <- read.table("cis_count5_new_0.95.bed", header = T)
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2a.png", width = 3.5, height = 4.5, dpi = 600)
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2a.pdf", width = 3.5, height = 4.5, dpi = 600)