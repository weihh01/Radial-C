...
library(openxlsx)
library(ggplot2)
setwd('G:/AI_XuLab_Data/Radial-C/figureS1/FigS1/FigS1c/insulation/')
...
library(openxlsx)
library(ggplot2)
setwd('G:/AI_XuLab_Data/Radial-C/figureS1/FigS1/FigS1c/pc1/')
...
ggsave("G:/AI_XuLab_Data/Radial-C/figS1c.pdf", width = 6, height = 3)
ggsave("G:/AI_XuLab_Data/Radial-C/figS1c.png", width = 6, height = 3, dpi = 600)