...
setwd("G:/AI_XuLab_Data/Radial-C/figureS2/FigS2d")
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2d_MNase-1min_5kb_layer.png", width = 4, height = 4, dpi = 600)
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2d_MNase-1min_5kb_layer.pdf", width = 4, height = 4, dpi = 600, device = cairo_pdf)
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2d_MNase-5min_5kb_layer.png", width = 4, height = 4, dpi = 600)
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS2d_MNase-20min_5kb_layer.png", width = 4, height = 4, dpi = 600)