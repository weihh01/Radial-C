...
setwd("G:/AI_XuLab_Data/Radial-C/figureS6/s6g/")
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS6g_inward_CTCF-static_MAZ.pdf", width = 2.8, height = 2.6, dpi = 600, device = cairo_pdf)
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS6g_static_CTCF-static_MAZ.pdf", width = 2.8, height = 2.6, dpi = 600, device = cairo_pdf)
...
ggsave(filename = "G:/AI_XuLab_Data/Radial-C/figS6g_static_CTCF-inward_MAZ.pdf", width = 2.8, height = 2.6, dpi = 600, device = cairo_pdf)
