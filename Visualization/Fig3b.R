  ...
  PC1<-fread("/mnt/disk2/2/zqf/private/radial/Hs_100kb_two_scale_score01_OE_20minPC1.bed")
  ...
  ggplot(angle_1, aes((score+0.1)*cos,(score+0.1)*sin)) +
      geom_point(aes(color=signal),size = 0.2,alpha=0.5)+ 
      ...
      scale_color_gradientn(breaks=c(-2,-1,0,1,2,3,4),
                            colours = c("#191970","#00008B","#b2b2cf","#cc5555","#c43939","#bb1c1c","#b30000"),
  ...
  ggsave("/mnt/disk2/2/zqf/private/radial/PC1_3.pdf",width=6, height=5,units = "in",limitsize = F)
