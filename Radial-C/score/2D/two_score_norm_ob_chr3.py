...
fr = open("/mnt/disk4/whh/score/bin/100kb/chr3.bed")
...
fr = open("MNase-1min_OE_chr3.bed")
...
fr = open("MNase-5min_OE_chr3.bed")
...
fr = open("MNase-20min_OE_chr3.bed")
...
np.savetxt("col_ave_OE_chr3.txt",col_ave,fmt='%.6f')
np.savetxt("returnMat_ob_chr3.txt",returnMat_all,fmt='%.6f')
...
np.savetxt("col_ave_OE_chr3_new.txt",col_ave,fmt='%.6f')
