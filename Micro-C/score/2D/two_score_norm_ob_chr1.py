...
fr = open("/mnt/disk4/whh/score/bin/100kb/chr1.bed")
...
fr = open("MNase-1min_OE_chr1.bed")
...
fr = open("MNase-5min_OE_chr1.bed")
...
fr = open("MNase-20min_OE_chr1.bed")
...
np.savetxt("col_ave_OE_chr1_new.txt",col_ave,fmt='%.6f')
