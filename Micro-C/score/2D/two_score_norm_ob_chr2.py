...
fr = open("/mnt/disk4/whh/score/bin/100kb/chr2.bed")
...
fr = open("MNase-1min_OE_chr2.bed")
...
fr = open("MNase-5min_OE_chr2.bed")
...
fr = open("MNase-20min_OE_chr2.bed")
...
np.savetxt("col_ave_OE_chr2.txt",col_ave,fmt='%.6f')
np.savetxt("returnMat_ob_chr2.txt",returnMat_all,fmt='%.6f')
...
np.savetxt("col_ave_OE_chr2_new.txt",col_ave,fmt='%.6f')
