for i in DMSO-1min_rep2 TPA-1min_rep2;do
	...
	mkdir ${i}
	cd ..
	cp trimLk/${i}_R1_val_1_trimlinker3.fq.gz data_${i}/${i}/${i}_trimlinker4_1.fq.gz
	cp trimLk/${i}_R2_val_2_trimlinker3.fq.gz data_${i}/${i}/${i}_trimlinker4_2.fq.gz
